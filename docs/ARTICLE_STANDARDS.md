...
**Current state:** `jakarta-vs-singapore-bangkok` (April 2026) used Style A (hero). Next article uses Style B.
...
Rotation state: `jakarta-vs-singapore-bangkok` (April 2026) is Eileen Fisher. Next article is Engelina Sutantio.
