...
**Current state:** `after-school-activities-jakarta` (April 2026) used Style A (hero image). Next article uses Style B.
...
Rotation state: `after-school-activities-jakarta` (April 2026) is Eileen Fisher. Next article is Engelina Sutantio.
