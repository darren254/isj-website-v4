...
**Current state:** `international-schools-map-jakarta` (April 2026) used Style B (no hero — no qualifying image available). Next article uses Style A.
...
Rotation state: `international-schools-map-jakarta` (April 2026) is Eileen Fisher. Next article is Engelina Sutantio.
