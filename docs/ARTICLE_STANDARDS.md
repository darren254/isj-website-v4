...
**Current state:** `isj-in-the-news` (April 2026) used Style B (no hero). Next article uses Style A.
...
Rotation state: `isj-in-the-news` (April 2026) is Engelina Sutantio. Next article is Eileen Fisher.
