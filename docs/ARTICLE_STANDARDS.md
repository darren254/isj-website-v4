...
**Current state:** `visas-permits-documentation-jakarta-schools` (April 2026) used Style B (no hero image). Next article uses Style A.
...
Rotation state: `visas-permits-documentation-jakarta-schools` (April 2026) is Engelina Sutantio. Next article is Eileen Fisher.
