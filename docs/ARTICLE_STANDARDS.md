...
**Current state:** `british-ib-american-australian-curricula` (April 2026) used Style A (hero). Next article uses Style B.
...
Rotation state: `british-ib-american-australian-curricula` (April 2026) is Eileen Fisher. Next article is Engelina Sutantio.
